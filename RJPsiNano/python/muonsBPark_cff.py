...
#        inTimeMuon = Var("passed('InTimeMuon')",bool,doc="inTimeMuon ID"),
        ...
        isDimuon0_jpsi_Trg = Var("userInt('isDimuon0_jpsi_Trg')", int,doc="flag if the Dimuon0_jpsi path was triggered and the muon is matched"),
        isDimuon43_jpsi_displaced_Trg = Var("userInt('isDimuon43_jpsi_displaced_Trg')", int,doc="flag if the Dimuon0_jpsi path was triggered and the muon is matched"),
        isDimuon0_jpsi_4R_Trg = Var("userInt('isDimuon0_jpsi_4R_Trg')", int,doc="flag if HLT_Dimuon0_Jpsi_L1_4R_0er1p5R_v path was triggered and the muon is matched"),
        isMu8_Trg = Var("userInt('isMu8_Trg')", int, doc="flag if the HLT Mu8 is faried and matched to the muon"), 
        isIsoMu24_Trg = Var("userInt('isIsoMu24_Trg')", int, doc="flag if the HLT IsoMu24 is faried and matched to the muon"),
        isDimuon0Trg_HLT = Var("userInt('isDimuon0Trg_HLT')", int,doc="prescale if the Dimuon0 path was triggered"),
        isJpsiTrkTrg_HLT = Var("userInt('isJpsiTrkTrg_HLT')", int,doc="prescale if the JpsiTrkTrg path was triggered"),
        isJpsiTrk_PsiPrimeTrg_HLT = Var("userInt('isJpsiTrk_PsiPrimeTrg_HLT')", int,doc="prescale if the JpsiTrk_PsiPrimeTrg path was triggered"),
        isJpsiTrk_NonResonantTrg_HLT = Var("userInt('isJpsiTrk_NonResonantTrg_HLT')", int,doc="prescale if the JpsiTrk_NonResonantTrg path was triggered"),
        isDoubleMuTrg_HLT = Var("userInt('isDoubleMuTrg_HLT')", int,doc="prescale if the DoubleMu  path was triggered"),
        isDimuon0_jpsi_Trg_HLT = Var("userInt('isDimuon0_jpsi_Trg_HLT')", int,doc="prescale if the Dimuon0_jpsi path was triggered and the muon is matched"),
        isDimuon43_jpsi_displaced_Trg_HLT = Var("userInt('isDimuon43_jpsi_displaced_Trg_HLT')", int,doc="prescale if the Dimuon0_jpsi path was triggered and the muon is matched"),
        isDimuon0_jpsi_4R_Trg_HLT = Var("userInt('isDimuon0_jpsi_4R_Trg_HLT')", int,doc="prescale if HLT_Dimuon0_Jpsi_L1_4R_0er1p5R_v path was triggered and the muon is matched"),
        isMu8_Trg_HLT = Var("userInt('isMu8_Trg_HLT')", int, doc="prescale if the HLT Mu8 is faried and matched to the muon"),
        isIsoMu24_Trg_HLT = Var("userInt('isIsoMu24_Trg_HLT')", int, doc="prescale if the HLT IsoMu24 is faried and matched to the muon"),
#        isDimuon0Trg_L1ps = Var("userInt('isDimuon0Trg_L1ps')", int,doc="prescale if the Dimuon0 path was triggered"),                                                            
#        isJpsiTrkTrg_L1ps = Var("userInt('isJpsiTrkTrg_L1ps')", int,doc="prescale if the JpsiTrkTrg path was triggered"),
#        isJpsiTrk_PsiPrimeTrg_L1ps = Var("userInt('isJpsiTrk_PsiPrimeTrg_L1ps')", int,doc="prescale if the JpsiTrk_PsiPrimeTrg path was triggered"),                            
                     
#        isJpsiTrk_NonResonantTrg_L1ps = Var("userInt('isJpsiTrk_NonResonantTrg_L1ps')", int,doc="prescale if the JpsiTrk_NonResonantTrg path was triggered"),                   
              
#        isDoubleMuTrg_L1ps = Var("userInt('isDoubleMuTrg_L1ps')", int,doc="prescale if the DoubleMu  path was triggered"),        
#        isDimuon0_jpsi_Trg_L1ps = Var("userInt('isDimuon0_jpsi_Trg_L1ps')", int,doc="prescale if the Dimuon0_jpsi path was triggered and the muon is matched"),                  
#        isDimuon43_jpsi_displaced_Trg_L1ps = Var("userInt('isDimuon43_jpsi_displaced_Trg_L1ps')", int,doc="prescale if the Dimuon0_jpsi path was triggered and the muon is matched"),                    
#        isDimuon0_jpsi_4R_Trg_L1ps = Var("userInt('isDimuon0_jpsi_4R_Trg_L1ps')", int,doc="prescale if HLT_Dimuon0_Jpsi_L1_4R_0er1p5R_v path was triggered and the muon is matched"),                   
#        isMu8_Trg_L1ps = Var("userInt('isMu8_Trg_L1ps')", int, doc="prescale if the HLT Mu8 is faried and matched to the muon"),
#        isIsoMu24_Trg_L1ps = Var("userInt('isIsoMu24_Trg_L1ps')", int, doc="prescale if the HLT IsoMu24 is faried and matched to the muon"),
...
muonTriggerMatchedTable = muonBParkTable.clone(
    ...
    variables = cms.PSet(CandVars,
        ...
        trgMuonDimuon0_jpsi_index = Var("userInt('trgMuonDimuon0_jpsi_index')", int,doc="index in trigger muon collection"),
        trgMuonDimuon43_jpsi_displaced_index = Var("userInt('trgMuonDimuon43_jpsi_displaced_index')", int,doc="index in trigger muon collection"),
        ...
        trgMuonMu8_index = Var("userInt('trgMuonMu8_index')", int, doc="index in trigger muon collection"),
       # **trig_dict
   )
)
